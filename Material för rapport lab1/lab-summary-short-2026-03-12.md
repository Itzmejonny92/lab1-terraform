...
Nar jag korde `terraform plan` och `terraform apply` igen kvarstod felet. `apply` misslyckades fortfarande med samma `403`, vilket bekraktade att den kvarvarande blockern ar IAM-rattigheter i projektet.
